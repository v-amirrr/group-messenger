...
const AuthPage = () => {
    ...
    return (
        <Auth onSubmit={handleSubmit(submitHandler)} {...framerMotionAttributes(loginVariants)} authMode={authMode}>
            <AnimatePresence>
                ...
                <motion.input 
                    ...
                    layout
                />
                <motion.div className='password-container' key='password-container' {...framerMotionAttributes(loginItemVariants)} layout>
                    <input 
                ...
                <motion.div className='clear-submit-container' key='clear-submit-container' {...framerMotionAttributes(loginItemVariants)} layout>
                    <button type='button' className='clear-button' onClick={() => reset()}>Clear</button>
                    <button type='submit' className='submit-button'>Submit</button>
                </motion.div>
                <motion.button type='button' className='google-button' key='google-button' onClick={googleLogin} {...framerMotionAttributes(loginItemVariants)} layout>
                ...
                <motion.button type='button' className='guest-button' key='guest-button' onClick={guestLogin} {...framerMotionAttributes(loginItemVariants)} layout>
                    <i><FaUserLock /></i>
                    Guest Mode
                </motion.button>
            </AnimatePresence>
