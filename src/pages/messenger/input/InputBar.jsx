...
import { inputBarVariants, inputBarButtonVariants } from '../../../config/variants';
...
const InputBar = () => {
    ...
    return (
        <InputBarContainer {...framerMotionAttributes(inputBarVariants)} isPerian={isPersian(inputText) ? 1 : 0} inputText={inputText.length>0 ? 1 : 0} emojiPickerShow={emojiPickerShow ? 1 : 0}>
            ...
            <div className='input'>
                ...
                <AnimatePresence>
                    {
                        inputText ?
                        <motion.button className='send-button' {...framerMotionAttributes(inputBarButtonVariants)} onClick={sendHandler}>
                            <IoSend />
                        </motion.button>
                        : null
                    }
